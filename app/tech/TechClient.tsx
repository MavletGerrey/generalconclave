          ...
          {items.map((s, i) => (
            <FadeUp key={s.id} delay={i * 0.12} className="liquid-glass" style={{ padding: "40px", display: "flex", flexDirection: "column" }}>
              ...
              <button
                ...
                style={{ width: "100%", textAlign: "center", border: "1px solid rgba(255,255,255,0.15)", cursor: "pointer" }}
              >
                Оставить заявку
              </button>
            </FadeUp>
          ...
          <FadeUp delay={0}>
            <div className="liquid-glass-dark" style={{ padding: "56px 48px" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", flexWrap: "wrap", gap: "1rem", marginBottom: "2.5rem" }}>
                ...
                <button
                  onClick={() => setModalService("Отзыв")}
                  className="btn-apple-ghost"
                  style={{ fontSize: "0.82rem", border: "1px solid rgba(255,255,255,0.15)", cursor: "pointer" }}
                >
                  Оставить отзыв
                </button>
              </div>
              <div style={{ textAlign: "center", padding: "48px 0" }}>
                ...
                <button
                  onClick={() => setModalService("Заявка на разработку")}
                  style={{ color: "var(--accent)", fontSize: "0.85rem", marginTop: "1rem", display: "inline-block", background: "none", border: "none", cursor: "pointer" }}
                >
                  Оставить заявку →
                </button>
              </div>
